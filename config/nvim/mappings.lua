...
-- plugins
map('n', '<Space>i', ':Neotree toggle<CR>', { noremap = true, silent = true })
map('n', '<Space>t', ':FzfLua files<CR>', { noremap = true, silent = true })
map('n', '<C-f>.', ':FzfLua lgrep_curbuf<CR>', { noremap = true, silent = true })
map('n', '<C-f>,', ':FzfLua grep_visual<CR>', { noremap = true, silent = true })
...
map('i', '<C-j>', "<esc>:m .+1<CR>li", { noremap = true, silent = true })
map('i', '<C-k>', "<esc>:m .-2<CR>li", { noremap = true, silent = true })
